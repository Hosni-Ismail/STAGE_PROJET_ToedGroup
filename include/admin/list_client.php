...
$pdoStat =  $pdo->prepare('SELECT * FROM users ORDER BY name ASC');
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-indigo);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="list_client.php"><i class="fas fa-table"></i><span>Client</span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
