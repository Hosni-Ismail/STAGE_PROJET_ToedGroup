        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="rf-register-form">
                    <form class="rg-form" method="post" action="traitement_chantier.php">
                        <div class="rf-input-container"><input class="form-control rf-input-field" type="text" name="nom_chantier" placeholder="Nom du chantier"></div>
                        <div class="rf-input-container"><input class="form-control rf-input-field" type="text" name="type_c"placeholder="Type"></div>
