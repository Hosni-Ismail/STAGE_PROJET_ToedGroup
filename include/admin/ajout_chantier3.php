            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Ajout d'un chantier</h3>
                    </div>
                    <form method="post" action="traitement_chantier.php">
                        <input class="form-control" type="text" placeholder="Nom du chantier" name="nom_chantier"><input class="form-control" type="text" placeholder="Type" name="type_c"><input class="form-control" type="text" placeholder="Priorite" name="priorite"> <input class="form-control" type="text" placeholder="Ville" name="ville_chantier"><input class="form-control" type="date" name="date_c">
                        ...
                        <select name="user_id" style="border-color: rgb(218,218,218);border-radius: 4px;color: rgb(78,77,77);">
                                    ...
                                    <select name="statut" style="border-color: rgb(218,218,218);border-radius: 4px;color: rgb(78,77,77);">
                        ...
                        <button class="btn btn-primary" type="submit" name="envoi" style="width: 225.075px;height: 35px;margin: 20px;padding: 6px 12px;">Ajouter</button></form>
                </div>
            </div>
